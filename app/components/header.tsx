...
import { FileSpreadsheet, Download, BookOpen, Calculator } from "lucide-react"
...
export default function Header({ onDownloadTemplate, onShowManual, onShowSemaforo }: HeaderProps) {
  return (
